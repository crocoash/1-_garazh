...
Процедура НачалоВыбораСтатьяНалоговойДекларации(ЭлементФормы, СтандартнаяОбработка, НазваниеНалоговойДекларации, Набор = Неопределено) Экспорт
	...
	//Если (НазваниеНалоговойДекларации=Перечисления.ВидыНалоговыхДеклараций.ЕдиныйНалог) И (ЮрФизЛицо=Перечисления.ЮрФизЛицо.ФизЛицо) Тогда
	//	СписокНалоговыхДеклараций = Новый СписокЗначений();
	//	СписокНалоговыхДеклараций.Добавить(Справочники.СтатьиНалоговыхДеклараций.ЕН_);
	//	СписокНалоговыхДеклараций.Добавить(Справочники.СтатьиНалоговыхДеклараций.ЕН_Затраты);
	//	СписокНалоговыхДеклараций.Добавить(Справочники.СтатьиНалоговыхДеклараций.ЕН_Реализация);
	//			
	//	ФормаВыбора.СправочникСписок.Отбор.Ссылка.ВидСравнения  = ВидСравнения.ВСписке;
	//	ФормаВыбора.СправочникСписок.Отбор.Ссылка.Значение      = СписокНалоговыхДеклараций;			

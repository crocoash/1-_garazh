...
Функция СократитьВалюту(Текст) Экспорт
	...
	СоответствиеЗамен.Вставить("гривень", "грн.");
	СоответствиеЗамен.Вставить("гривні",  "грн.");
	СоответствиеЗамен.Вставить("гривня",  "грн."); 
	СоответствиеЗамен.Вставить("гривна",  "грн.");

	
	СоответствиеЗамен.Вставить("копійок", "коп.");
	СоответствиеЗамен.Вставить("копійки", "коп.");
	СоответствиеЗамен.Вставить("копійка", "коп.");
	
	Для Каждого Элемент Из СоответствиеЗамен Цикл
		Текст = СтрЗаменить(Текст, Элемент.Ключ, Элемент.Значение);
	КонецЦикла;

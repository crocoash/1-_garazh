...
//
Процедура ДобавитьФайлы(ОбъектФайла, ВидДанных = Неопределено, ИмяСправочника = "ХранилищеДополнительнойИнформации", НачальныйКаталог = "") Экспорт
	...
	Диалог = ПолучитьДиалогВыбораФайлов(Истина,НачальныйКаталог);

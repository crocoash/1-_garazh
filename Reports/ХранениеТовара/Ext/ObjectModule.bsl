...
//	ПостроительОтчета.ДобавитьИзмерениеСтроки("Контрагент");
...
Процедура УстановитьНачальныеНастройки(УниверсальныйОтчет = Ложь, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ДобавитьИзмерениеСтроки("Контрагент");
	ДобавитьИзмерениеСтроки("ДокументХранения");	
	ДобавитьИзмерениеСтроки("Номенклатура");

	
	//	ПостроительОтчета.ДобавитьИзмерениеСтроки("НарядНаПроизводство");
